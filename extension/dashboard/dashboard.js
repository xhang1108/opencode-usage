...
import { stringifyRates as stringifyRatesJson, parseRatesJson, validateRates } from "./settings/rates-io.js";
...
// stringifyRates/parseRatesJson/validateRates live in settings/rates-io.js.
function stringifyRates(models) {
  return stringifyRatesJson(models, RATES_VERSION);
}
